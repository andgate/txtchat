...
getLibDir = catchIO (getEnv "txtchat_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "txtchat_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "txtchat_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "txtchat_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "txtchat_sysconfdir") (\_ -> return sysconfdir)
